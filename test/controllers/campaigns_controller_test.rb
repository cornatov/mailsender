...
class CampaignsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create campaign" do
    assert_difference('Campaign.count') do
      post campaigns_url, params: { campaign: { body: @campaign.body, subject: @campaign.subject, to_email: @campaign.to_email } }
    end
  ...
  test "should update campaign" do
    patch campaign_url(@campaign), params: { campaign: { body: @campaign.body, subject: @campaign.subject, to_email: @campaign.to_email } }
